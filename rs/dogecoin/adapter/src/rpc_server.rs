use crate::{
    ...
    proto::doge_adapter_server::{DogeAdapter, DogeAdapterServer},
    proto::{
...
#[tonic::async_trait]
impl DogeAdapter for DogeAdapterImpl {
...
pub fn spawn_grpc_server(
    ...
    tokio::spawn(async move {
        let doge_adapter_impl = DogeAdapterImpl::new(blockchain_manager, transaction_manager);

        Server::builder()
            .add_service(DogeAdapterServer::new(doge_adapter_impl))
            .serve(addr)
            .await
